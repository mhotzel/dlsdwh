...
from model.pfand import PfandImporter

def test_1(db_man: DbManager):
    '''Einfuegen neuer Kundendaten'''

    import_file = r"C:\Users\matth\Desktop\DLS\scs-daten_20230301\Pfand_1.txt"

    importer = PfandImporter(db_man, import_file)
...
def test_2(db_man: DbManager):
    ...
    import_file = r"C:\Users\matth\Desktop\DLS\scs-daten_20230301\Pfand_2.txt"
...
def test_3(db_man: DbManager):
    ...
    db_file = r"C:\Users\matth\Desktop\dlsdwh.db"
    import_file = r"C:\Users\matth\Desktop\DLS\scs-daten_20230301\Pfand_3.txt"
