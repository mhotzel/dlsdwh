...
from model.presseartikel import PresseArtikelImporter
from model.db_manager import DbManager

def test_1(db_man: DbManager):
    '''Einfuegen neuer Daten'''

    import_file = r"C:\Users\matth\Desktop\DLS\scs-daten_20230301\Presseartikel_1.txt"

    importer = PresseArtikelImporter(db_man, import_file)

    importer.load_file()
    print(importer.df_artikel)
    print()
    print(importer.df_liefart)
    print()
    importer.write_data()
...
def test_2(db_man: DbManager):
    ...
    import_file = r"C:\Users\matth\Desktop\DLS\scs-daten_20230301\Presseartikel_2.txt"
...
def test_3(db_man: DbManager):
    ...
    db_file = r"C:\Users\matth\Desktop\dlsdwh.db"
    import_file = r"C:\Users\matth\Desktop\DLS\scs-daten_20230301\Presseartikel_3.txt"
